        ...
        <div className='w-full h-[100dvh]  '>
            <div className="relative h-full text-white">
                ...
                <div className="w-11/12 mx-auto absolute flex-col lg:flex-row left-1/2 -translate-x-1/2 bottom-10 flex lg:items-center  z-20 gap-4 lg:gap-0 lg:justify-between">
                    ...
                    <Link to={`/user/dashboard`} className="lg:w-[30%] w-fit gap-2 border cursor-pointer justify-between px-3 py-2.5 rounded-md flex  items-center  bg-white text-[var(--dark-green)]  ">
